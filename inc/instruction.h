...
class input_instr {
  public:
    ...
    uint64_t alloc_start;     // Start address of allocated memory
    uint64_t alloc_end;       // End address of allocated memory
    uint64_t alloc_size;      // Size of allocated memory
    uint64_t alloc_type;                      // Type: malloc, free, new, delete, etc.
